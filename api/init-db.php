...
function getDB() {
    ...
    if ($isNew) {
        ...
        $products = [
            [1,'Tesla Model 3 Standard Range Plus 2023',42000,'autos','used','Tesla','Model 3','2023','430','60 kWh LFP','Excelente estado, un solo dueño. Service oficial al día. Piloto automático incluido. Color blanco perla. Interior vegano negro.','https://images.pexels.com/photos/3802510/pexels-photo-3802510.jpeg?auto=compress&cs=tinysrgb&w=600','Buenos Aires, Argentina'],
            [1,'BYD Dolphin Mini 2024 - 0km',22500,'autos','new','BYD','Dolphin Mini','2024','310','44.9 kWh','Nuevo, sin patentar. Color azul oceáno. Ideal ciudad. Carga rápida DC. Garantía oficial 6 años o 150.000 km.','https://images.pexels.com/photos/210019/pexels-photo-210019.jpeg?auto=compress&cs=tinysrgb&w=600','Buenos Aires, Argentina'],
            [2,'Nissan Leaf 40kWh 2022',28000,'autos','used','Nissan','Leaf','2022','270','40 kWh','Segunda mano, 25.000 km. ProPilot. Batería en excelente estado (95% SOH). Cargador incluido.','https://images.pexels.com/photos/1592384/pexels-photo-1592384.jpeg?auto=compress&cs=tinysrgb&w=600','Santiago, Chile'],
            ...
            [3,'Zero SR/F 2023 - Moto deportiva eléctrica',19800,'motos','used','Zero','SR/F','2023','260','14.4 kWh','La moto eléctrica más potente. 110 HP, 0-100 en 3.5s. 5.000 km. Carga rápida Level 2.','https://images.pexels.com/photos/2519374/pexels-photo-2519374.jpeg?auto=compress&cs=tinysrgb&w=600','Ciudad de México, México'],
